<?php
/**
* @version $Id: mod_search_bkmea.php,v 1.6 2006/05/22 06:16:57 nnabi Exp $
* @package Mambo
...
<form action="<?php $PHPSELF;?>" method="post" name="adminForm" id="dm_frmsearch">
<div align="center" class="search<?php echo $moduleclass_sfx; ?>">
