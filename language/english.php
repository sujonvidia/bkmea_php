...
DEFINE('_CREATE_ACCOUNT','Create an username and password');
...
DEFINE('_REG_COMPLETE', '<div class="componentheading">Registration Complete!</div><br />System will send your password to your email address.');
...
DEFINE('_NEW_PASS_DESC','Please enter your Username and e-mail address then click on the \'Get Hints\' button to retrieve your  <br />'
.'hint. If you can remember your password from the hint use that for login. Or click on \'Send Password\' button to receive a new password shortly. Use this new password to access the site.');
...
DEFINE('_PROMPT_KEYWORD','Keyword Search');
...
DEFINE('_USER_PASSWORD_SAVE','Password is changed successfully.');
...
/** components/search/ */
DEFINE( '_PROFILE_REQUEST_SUBJECT','Member Profile Request');
DEFINE( '_MESSAGE_1','Hi '.$mosConfig_fromname.',');                 //$mosConfig_fromname -> from global configuration
DEFINE( '_MESSAGE_2','Please send detail information of ');    //$firm_name          -> requested firm name
DEFINE( '_MESSAGE_3','Registration number: ');  //$firm_reg_no        -> requested member registration no
DEFINE( '_MESSAGE_4','Sincerely, ');                           //$my->name           -> Sender name
...
DEFINE('_MAINMENU_DEL','* You cannot `delete` this menu as it is required for the proper operation *');
...
/** header detail for report */
DEFINE('_CHAMBER_NAME_BKMEA','Bangladesh Knitwear Manufacturers & Exporters Association');
DEFINE('_ADDRESS_BKMEA','233/1, B.B. Road, Naraynganj Press Club Building(1st Floor), Naraynganj-1400, Bangladesh');
DEFINE('_CONTACT_NUMBER_BKMEA','');
DEFINE('_EMAIL_BKMEA','E-mail: ');
DEFINE('_WEB_BKMEA','Website: www.bkmea.org');
//CCCI
DEFINE('_CHAMBER_NAME_CCCI','Chittagong Chamber of Commerce & Industry');
DEFINE('_ADDRESS_CCCI','Chamber House, 38 Agrabad C/A, Chittagong, Bangladesh.');
DEFINE('_CONTACT_NUMBER_CCCI','Phone: 88-031-713366, Fax: 88-031-71083');
DEFINE('_EMAIL_CCCI','E-mail: ccci@globalctg.net');
DEFINE('_WEB_CCCI','Website: www.chittagong.org');
//SCCI
DEFINE('_CHAMBER_NAME_SCCI','The Sylhet Chamber of Commerce & Industry');
DEFINE('_ADDRESS_SCCI','CHAMBER BUILDING, JAIL ROAD, P.O. BOX NO. 97, SYLHET, BANGLADESH');
DEFINE('_CONTACT_NUMBER_SCCI','Tel: (0821)714403, 716069, 810566, Fax:880-821-715210');
DEFINE('_EMAIL_SCCI','E-mail: scci@btsnet.net');
DEFINE('_WEB_SCCI','Website: www.sylhetchamber.org');
//EPB
DEFINE('_ORG_NAME','Export Promotion Bureau');
DEFINE('_ADDRESS_EPB','1, Karwan Bazar(1st Floor), Dhaka-1215, Bangladesh');
DEFINE('_CONTACT_NUMBER_EPB','PABX: 9144821-24, Fax: 88-02-9119531');
DEFINE('_EMAIL_EPB','E-mail: epb.tic@pradeshta.net');
DEFINE('_WEB_EPB','Website: www.epbbd.com');
DEFINE('_EMAIL_EPB_FOR_FRONT','epb.tic@pradeshta.net');
DEFINE('_WEB_EPB_FOR_FRONT','www.epbbd.com');

/** administrators/components/com_massmail */
DEFINE('_SITE_SLOGAN', 'Information Management System');
DEFINE('_FORCED_LOGOUT', 'You are forced fully logout by the Administrator')
