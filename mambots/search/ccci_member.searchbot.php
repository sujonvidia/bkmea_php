<?php
/**
* @version $Id: ccci_member.searchbot.php,v 1.4 2006/02/09 11:09:19 morshed Exp $
* @package Mambo
...
function botSearchMember( $text, $phrase='',  $search_type='all', $product='all', $location='all') {
        ...
        */
        ...
        $sql = "SELECT distinct( m.firm_name ) AS firm_name, m.id as id "
               ...
               . "\n WHERE m.id NOT IN (select old_member_id as id from #__expire_member_maping) and ( $where ) $product_search $location_search "
               ;
