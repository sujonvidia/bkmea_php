<?php
/**
* @version $Id: offline.php,v 1.4 2005/01/06 01:13:28 eddieajau Exp $
* @package Mambo
...
<tr>
        ...
        <img src="<?php echo $mosConfig_live_site; ?>/images/<?php echo strtolower($mosConfig_owner);?>_logo.png" alt="Mambo Logo" align="middle" />
        </td>
</tr>
<tr>
        <td align="center">
