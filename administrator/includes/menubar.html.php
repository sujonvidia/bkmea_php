<?php
/**
* @version $Id: menubar.html.php,v 1.18 2005/02/16 05:14:57 kochp Exp $
* @package Mambo
...
class mosMenuBar {
        ...
        */
        ...
        function startTable() {
                ...
                <style>
                <?php if(!class_exists('joomlaVersion')) { //padding: 1px 1px 1px 1px;
                ?>
                        table#toolbar {
                                margin-right: 0px;
                        }
        ...
        */
        ...
        function navX( $img='', $task='', $alt='' ) {
                $image = mosAdminMenus::ImageCheckAdmin( $img.'.png', '/administrator/images/', NULL, NULL, $alt, $task );
                $image2 = mosAdminMenus::ImageCheckAdmin( $img.'_f2.png', '/administrator/images/', NULL, NULL, $alt, $task, 0 );
                ?>
                <td>
                <a class="toolbar" href="javascript:hideMainMenu();submitbutton('<?php echo $task;?>');" onmouseout="MM_swapImgRestore();"  onmouseover="MM_swapImage('<?php echo $task;?>','','<?php echo $image2; ?>',1);">
                <?php echo $image; ?>
