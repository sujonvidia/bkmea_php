<?php
/**
* @version $Id: admin.info_product_sales_report_bkmea.html.php,v 1.3 2006/05/14 10:08:27 nnabi Exp $
* @package Mambo
                ...
                <tr>
                        <td valign="top" width="60%">
                               ...
                               <tr width=100%>
                                        ...
                                        <option value="201">Info Product Sale</option>
                               ...
                               <tr width=100%>
                                        <td  align="right">
                                        <div align=right>Info Products :</div>
                                        </td>
                                        <td >
