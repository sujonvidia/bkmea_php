<?php
/**
* @version $Id: admin.member_reg_year_scci.html.php,v 1.9 2006/03/08 10:19:12 sami Exp $
* @package Mambo
        ...
        */
        function show( &$rows, &$pageNav) {
                ...
                for ($i=0, $n=count( $rows ); $i < $n; $i++) {
                        ...
                        $link = 'index2.php?option=com_member_reg_year_scci&task=editA&hidemainmenu=1&id='. $row->id;
                ...
                <input type="hidden" name="option" value="com_member_reg_year_scci" />
        ...
        */
        function edit( &$row, &$lists, $redirect, $menus, $prev_end_date ) {
                ...
                function submitbutton(pressbutton, section) {
                        ...
                        if(form.name.value == ""){
                            alert("You must enter name of the registration year");
                            form.name.focus();
