<?php
/**
* @version $Id: admin.config_ccci.php,v 1.7 2006/05/07 05:10:08 nnabi Exp $
* @package Camellia
* @subpackage Config
...
///        var $config_favicon=null;
        ...
        var $config_owner='CCCI';

        //election board
        var $config_member_1='';
        var $config_member_2='';
        var $config_chairman='';
        var $config_secretary='';
        var $config_notice='';
        //info product
        ...
        var $config_directory_link = 'index.php?option=com_search_ccci&amp;Itemid=5';
        ...
        function mosConfig() {
                ...
                // added by Team Camellia for additional policies
                'config_voter_election_date'         =>'config_voter_election_date',
                ...
                // added by Mizan for additional policies
                //election board
                'config_member_1'                =>'config_member_1',
                'config_member_2'                =>'config_member_2',
                'config_chairman'                =>'config_chairman',
                'config_secretary'                =>'config_secretary',
...
require_once( str_replace('\\','/',dirname(__FILE__)) . '/admin.config_ccci.html.php' );
...
function showconfig($confightml, &$database, $option) {
        ...
        if( intval($_POST['working_reg_year_id'])== 0 )
            $year_id=intval($_SESSION['working_reg_year_id']);
        else
            $year_id=intval($_POST['working_reg_year_id']);
        ...
        $lists['working_reg_year_id']          = mosAdminMenus::RegYear( 'working_reg_year_id', $year_id , '', $javascript );
        $confightml->showconfig( $row, $lists, $option, $start_date, $end_date );
}
...
function saveconfig( $task ) {
    ...
    $enable_write = mosGetParam($_POST,'enable_write',0);
        ...
        if ( $fp = fopen($fname, 'w') )
        {
                ...
                switch ( $task ) {
                        case 'apply':
                                mosRedirect( 'index2.php?option=com_config_ccci&hidemainmenu=1', $msg );
                                break;
