<?php
/**
* @version $Id: admin.config_ccci.html.php,v 1.21 2006/12/21 11:51:52 morshed Exp $
* @package Mambo
* @subpackage Config
...
class HTML_config {
        ...
        function showconfig( &$row, &$lists, $option, $start_date, $end_date ) {
                ...
                global $my,$mosconfig_calender_date_format,$config_voter_election_date;        // added by camellia team to validate access control
                global $config_member_1; //election board
                $tabs = new mosTabs(1);
?>
                ...
                function submitbutton(pressbutton) {
                      ...
                      /*  start =trim(form.start_date.value);
                        ...
                        */
                        ...
                        else if(trim(form.config_voter_election_date.value)==""){
                                alert("Election Date Can't be blank");
...
<?php
        ...
        <?php
                if ($my->usertype=='Super Administrator')
                        {?>
                        <tr>
                                <td colspan=2><b>Election Board</b></td>
                        </tr>
                        <tr>
                                <td>Member 1:</td>
                                <td><input class="text_area" type="text" name="config_member_1" size="40" value="<?php echo $row->config_member_1; ?>"/></td>
                        </tr>
                        <tr>
                                <td>Member 2:</td>
                                <td><input class="text_area" type="text" name="config_member_2" size="40" value="<?php echo $row->config_member_2; ?>"/></td>
                        </tr>
                        <tr>
                                <td>Chairman:</td>
                                <td><input class="text_area" type="text" name="config_chairman" size="40" value="<?php echo $row->config_chairman; ?>"/></td>
                        </tr>
                        <tr>
                                <td>Secretary:</td>
                                <td><input class="text_area" type="text" name="config_secretary" size="40" value="<?php echo $row->config_secretary; ?>"/></td>
                        </tr>
                        <tr>
                                <td valign=top>Notice:</td>
                                <td>
                                <?php  editorArea( 'config_notice',  stripslashes($row->config_notice) , 'config_notice', '60%;', '50', '60', '20' ) ; ?>
                                </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                                ...
                                <td><input class="text_area" type="text" name="config_voter_new_date" size="20" value="<?php echo $row->config_voter_new_date; ?>" onKeyUp="javascript:check_IntNumber('config_voter_new_date','Enter valid day(s)');" maxlength="5"/>
                                <?php echo mosToolTip('Members will be voter who have REGISTERED this days before the Election date'); ?>        </td>
                        </tr>
                        <tr>
                                <td>For Renewal:</td>
                                <td><input class="text_area" type="text" name="config_voter_renew_date" size="20" value="<?php echo $row->config_voter_renew_date; ?>" onKeyUp="javascript:check_IntNumber('config_voter_renew_date','Enter valid day(s)');" maxlength="5"/>
                        ...
                        <tr>
                                ...
                                <td>
                                        ...
                                        <input class="text_area" type="text" name="config_voter_election_date" id="config_voter_election_date" value="<?php echo $row->config_voter_election_date; ?>" size="20" maxlength="255"  readonly />
