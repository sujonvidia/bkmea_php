<?php
/**
* @version $Id: admin.non_member_scci.html.php,v 1.4 2006/02/20 11:15:28 morshed Exp $
* @package Mambo
* @subpackage Weblinks
        ...
        */
        ...
        function showMembership( $option, &$rows, &$lists, &$search, &$pageNav ) {
                ...
                for ($i=0, $n=count( $rows ); $i < $n; $i++) {
                        ...
                        $link         = 'index2.php?option=com_non_member_scci&task=editA&hidemainmenu=1&id='. $row->id;
                        ...
                        else if(document.adminForm.tabselection.value=="0")
                        {
                                if(form.firm_name.value == ""){
                                     ...
                                     form.corporate_status.focus();
                                       ...
                                       alert("Proprietor name can't be blank");
                                       form.applicant_name.focus();
                                 }else if(form.applicant_designation.value == "0"){
                                        alert("You must enter Proprietor Designation");
                                ...
                                if(form.firm_reg_address_street.value == ""){
                                     alert("Please Enter Street/Area in Applicant Firm Information");
...
$tabs->endTab();
  ...
  $tabs->endPane() ;
                ...
                <!--input type="hidden" name="option" value="<?php echo $option;?>" /-->
                <input type="hidden" name="option" value="com_non_member_scci" />
