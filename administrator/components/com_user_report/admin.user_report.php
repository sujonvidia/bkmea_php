<?php
/**
* @version $Id: admin.user_report.php,v 1.2 2005/12/10 08:24:03 morshed Exp $
* @package Mambo
...
*/
function viewUser_Report( $option ) {
        global $database, $dbconn;
        global $type_id, $report_for, $date_from, $date_to;

        $lists=array();
        $lists['type_id']                   = mosAdminMenus::UserTypeList( 'type_id', $type_id );
        $lists['report_for']                = mosAdminMenus::UserReportFor( 'report_for', $report_for, 'u' );

        User_Report_html::View( $lists );
}
