<?php
/**
* @version $Id: admin.user_report.html.php,v 1.10 2006/04/26 06:47:45 nnabi Exp $
* @package Mambo
        ...
        */
        function View( &$lists) {
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_user_report&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;for='+'<?php echo $for; ?>';
                ...
                <input type="hidden" name="option" value="com_user_report_bkmea" />
