<?php
/**
* @version $Id: admin.config_scci.php,v 1.12 2006/05/04 08:00:22 morshed Exp $
* @package Camellia
* @subpackage Config
...
///        var $config_favicon=null;
        ...
        var $config_owner='SCCI';
        var $config_president_name='';
        var $config_designation_idcard='';
        ...
        var $config_directory_link = 'index.php?option=com_search_scci&amp;Itemid=5';
        ...
        function mosConfig() {
                ...
                'config_president_name'                               =>'mosconfig_president_name',
                'config_designation_idcard'                               =>'mosconfig_designation_idcard',
...
require_once( str_replace('\\','/',dirname(__FILE__)) . '/admin.config_scci.html.php' );
...
function saveconfig( $task ) {
        ...
        if ($my->usertype=='Manager')
        {
                ...
                switch ( $task ) {
                        case 'apply':
                                mosRedirect( 'index2.php?option=com_config_scci&hidemainmenu=1', $msg );
                                break;
