<?php
/**
* @version $Id: admin.member_reg_year_ccci.html.php,v 1.8 2006/03/09 06:36:01 nnabi Exp $
* @package Mambo
        ...
        */
        function show( &$rows, &$pageNav) {
                ...
                for ($i=0, $n=count( $rows ); $i < $n; $i++) {
                        ...
                        $link = 'index2.php?option=com_member_reg_year_ccci&task=editA&hidemainmenu=1&id='. $row->id;
                ...
                <input type="hidden" name="option" value="com_member_reg_year_ccci" />
