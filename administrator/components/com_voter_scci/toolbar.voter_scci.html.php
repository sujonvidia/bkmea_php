<?php
/**
* @version $Id: toolbar.voter_scci.html.php,v 1.2 2006/02/23 07:05:01 morshed Exp $
* @package Mambo
        ...
        */
        function _DEFAULT(){
               ...
               // mosMenuBar::publishList();
                mosMenuBar::spacer();
                //mosMenuBar::save( $task='save', $alt='Save');
                //mosMenuBar::save( $task='is_voter_not', $alt='No');
                mosMenuBar::navX( 'apply', 'save', 'Yes' );
                mosMenuBar::spacer();
                mosMenuBar::navX( 'cancel', 'is_voter_not', 'Voter No' );
