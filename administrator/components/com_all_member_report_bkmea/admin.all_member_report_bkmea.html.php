<?php
/**
* @version $Id: admin.all_member_report_bkmea.html.php,v 1.1 2006/07/05 06:35:27 morshed Exp $
* @package Mambo
        ...
        */
        function View( &$lists) {
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_all_member_report_bkmea&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;category_id='+member_category+'&amp;membership_no='+membership_no+'&amp;order_by='+order_by;
