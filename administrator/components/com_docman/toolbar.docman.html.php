...
* @version $Id: toolbar.docman.html.php,v 1.3 2006/12/26 06:30:06 morshed Exp $
...
class TOOLBAR_docman {
    ...
    function DOCUMENTS_MENU()
    {
        ...
        ($my->usertype=="Manager" && strtolower($mosConfig_owner)=="scci")?"":dmToolBar::deleteList();
        //dmToolBar::divider();
        //dmToolBar::cpanel();
        dmToolBar::endTable();
    }
    ...
    function CATEGORIES_MENU()
    {
        ...
        dmToolBar::publishList();
        dmToolBar::unpublishList();
        dmToolBar::addNew('new', 'New');
        dmToolBar::editList('edit','Edit');
        global $my,$mosConfig_owner;
        ($my->usertype=="Manager" && strtolower($mosConfig_owner)=="scci")?"":dmToolBar::deleteList();
        //dmToolBar::divider();
        //dmToolBar::cpanel();
