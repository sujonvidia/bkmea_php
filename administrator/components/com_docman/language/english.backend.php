...
* @version $Id: english.backend.php,v 1.4 2006/04/18 10:17:52 nnabi Exp $
...
DEFINE("_DML_ISUPLOADING"         , "Info Product is Uploading");
...
DEFINE("_DML_DOCMANISTRANSF"         , "Info Product is transfering<br />the file");
...
DEFINE("_DML_OWNER_TOOLTIP" , "This determines who can download. Choose: "
     . "<br><b>Everybody</b> if you want anyone to be able to access the document. "
     . "<b>All registered users</b> only allows users that have an account at your site access to the document. " );
...
DEFINE("_DML_CATNAME"                         , "Name of the Category");
...
DEFINE("_DML_CONFIGURATION"         , "Info Product Configuration");
...
DEFINE("_DML_CFG_DOCMANTT"                 , "Info Product...");
...
DEFINE("_DML_DOCSTATS"         , "Info Product statistics - Top 50 downloads");
