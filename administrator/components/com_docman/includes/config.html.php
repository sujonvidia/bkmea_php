...
* @version $Id: config.html.php,v 1.3 2006/04/17 03:42:30 nnabi Exp $
...
class HTML_DMConfig
{
    ...
    <table class="adminform">
        ...
        -->
        <tr>
            <td>Path for Backup</td>
            <td>
            <?php $mybackuppath = trim($mosConfig_absolute_path) . "/dmdocbackup";?>
            <input size="50" type="text" name="dmbackuppath" value="<?php if ($_DOCMAN->getCfg('dmbackuppath') == '') {
            echo $mybackuppath;
        } else echo stripslashes($_DOCMAN->getCfg('dmbackuppath'));?>">
            </td>
            <td><?php echo mosToolTip(_DML_CFG_PATHTT . '</span>', _DML_CFG_DOCMANTT . '<br />' . _DML_CFG_PATHFORSTORING);?>
            <input type="button" value="<?php echo _DML_RESETDEFAULT;?>" name="Reset" onclick="document.adminForm.dmbackuppath.value='<?php echo $mybackuppath;?>';">
            </td>
        </tr>
        <!--
        Added by Camellia Team
        ...
        -->
        <tr>
            <td>Path for DOwnload</td>
            <td>
            <?php $mydownloadpath = trim($mosConfig_absolute_path) . "/dmdocdownload";?>
            <input size="50" type="text" name="dmdownloadpath" value="<?php if ($_DOCMAN->getCfg('dmdownloadpath') == '') {
            echo $mydownloadpath;
        } else echo stripslashes($_DOCMAN->getCfg('dmdownloadpath'));?>">
            </td>
            <td><?php echo mosToolTip(_DML_CFG_PATHTT . '</span>', _DML_CFG_DOCMANTT . '<br />' . _DML_CFG_PATHFORSTORING);?>
            <input type="button" value="<?php echo _DML_RESETDEFAULT;?>" name="Reset" onclick="document.adminForm.dmdownloadpath.value='<?php echo $mydownloadpath;?>';">
            </td>
        </tr>
    </table>
        <?php
