...
* @version $Id: docman.html.php,v 1.2 2006/04/16 12:19:24 nnabi Exp $
...
class HTML_DMDocman
{
    ...
    function showStatistics(&$row)
    {
        ...
        <table class="adminheading">
            <tr>
                <th>Info Product Statistics : Top 50 downloads</th>
            </tr>
        </table>
        <br />
        <table class="adminlist" width="98%" cellspacing="2" cellpadding="2" border="0" align="center">
            <tr>
                <td width="15%" align="center"><b><?php echo _DML_RANK;?></b></td>
                <td width="60%"><b><?php echo _DML_NAME;?></b></td>
                <td width="25%" align="center"><b><?php echo _DML_DOWNLOADS;?></b></td>
            </tr>
                <?php
        $enum = 1;
        $color = 0;
