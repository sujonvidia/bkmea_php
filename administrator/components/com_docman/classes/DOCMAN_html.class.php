...
* @version $Id: DOCMAN_html.class.php,v 1.3 2006/04/13 07:13:03 nnabi Exp $
...
class dmHTML extends mosHTML
{
    ...
    function categoryList($id, $action, $options = array())
    {
        ...
        $parent = mosHTML::selectList($options, 'catid', ' class="inputbox" size="1" onchange="' . $action . '"', 'value', 'text', $id);
        return $parent;
    }
    ...
    function docEditFieldsJS($checkList = null, $id = 0)
    {
        $checks = array();
        if ($checkList) {
        ...
        ?>
            ...
            if (form.catid.value == "0") {
                $msg +="\nYou must select product category" ;
            }/*
