...
* @version $Id: DOCMAN_model.class.php,v 1.2 2006/03/23 04:16:32 nnabi Exp $
...
class DOCMAN_Document extends DOCMAN_Model
{
    ...
    function _format(&$objDBDoc)
    {
        ...
        //$file = new DOCMAN_file($objDBDoc->dmfilename, $_DOCMAN->getCfg('dmpath')); // blocked by camellia team
        $file = new DOCMAN_file($objDBDoc->dmfilename, $_DOCMAN->getCfg('dmpath'),$objDBDoc->catid); // added by camellia team
