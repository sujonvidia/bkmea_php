<?php
/**
* @version $Id: admin.accounts_transaction_report_ccci.html.php,v 1.2 2006/04/02 06:32:06 morshed Exp $
* @package Mambo
...
* @subpackage Categories
*/
class Accounts_Transaction_Report_html {
        ...
        */
        function View( &$lists,$option) {
                ...
                function createPdfLink(){
                      ...
                      if(report_for!=3){
                        ...
                        if(date_from!="" && date_to!="" && from.getTime()>to.getTime()){
                              alert("Date To must be greater or uqual to Date "+date_from);
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_accounts_transaction_report_ccci&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id;
                ...
                <tr>
                        <td valign="top" width="60%">
                                ...
                                <tr>
                                        ...
                                        <b>Accounts Transaction Report      </b>
                                        </td>
                               ...
                               <tr width=100%>
                                ...
                                <tr>
                                        ...
                                        <td  width=18% align=right>
                                        <?php
                                            Accounts_Transaction_Report_html::PdfIcon(  );
                                        ?>
                                        </td>
                                        </tr>
                                        </table>
                ...
                <input type="hidden" name="option" value="com_accounts_transaction_report_bkmea" />
