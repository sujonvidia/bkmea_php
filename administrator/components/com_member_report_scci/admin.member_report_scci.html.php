<?php
/**
* @version $Id: admin.member_report_scci.html.php,v 1.15 2006/06/19 06:51:47 morshed Exp $
* @package Mambo
...
class Member_Report_html {
        ...
        */
        function View( &$lists) {
                ...
                if (intval($for)==0 && intval($mailmerge)==0)
                    $title="Member List Report";
                else if (intval($for)==0 && intval($mailmerge)==1)
                    $title="Mailing List Report";
                else if (intval($for)==1)
                     $title="Outstanding Member Report";

                ?>
                <script language="javascript" type="text/javascript">

                function createPdfLink(){
                      var form, link, status, type_id, report_for, date_from='', date_to='', office_copy;
                      ...
                      var mailmerge=<?php echo $mailmerge?>;
                      //alert(mailmerge);
                      last_reg_year_id = <?php echo $_SESSION['working_reg_year_id']; ?>;

                      status = 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no';

                      //if(form.mailmerge.checked==true)
                      if (mailmerge==1)
                        link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_member_report_scci&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;mailmerge=1'+'&amp;membership_no='+membership_no;
                      else
                        link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_member_report_scci&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;office_copy='+office_copy+'&amp;mailmerge=0'+'&amp;membership_no='+membership_no;
                ...
                <tr>
                        <td valign="top" width="60%">
                               ...
                               <!--tr width=100%>
                                        ...
                                        <td >
                                        <input type="checkbox" name="mailmerge" value="1">
                                        Mail Merge Report
                                        </td>
                                </tr-->
                                <?php } ?>
