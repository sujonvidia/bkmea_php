<?php
/**
* @version $Id: admin.info_product_sales_report.html.php,v 1.9 2007/01/10 12:16:04 morshed Exp $
* @package Mambo
...
* @subpackage Categories
*/
class info_Product_Sales_Report_html {
        ...
        */
        function View( &$lists,$option) {
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_info_product_sales_report&amp;do_pdf=1&amp;info_product_category='+info_product_category+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;info_product='+info_product+'&amp;for='+'<?php echo $for; ?>';
                ...
                <tr>
                        <th class="categories">
                        <?php if(trim(strtolower($mosConfig_owner))=="epb"){ echo "Trade Lead Sales Report"; } else{ echo "Info Product Sales Report"; } ?>
                        </th>
                </tr>
                </table>
                ...
                <tr>
                        <td valign="top" width="60%">
                                ...
                                <tr>
                                        ...
                                        <b><?php echo trim(strtolower($mosConfig_owner))!="epb"?"Info Product Sales Report":"Trade Lead Sales Report"; ?>  </b>
                                        </td>
                                ...
                                <tr>
                                 <tr width=100%>
                                        ...
                                        <td width="75%">
                                        <select name="info_product">
                                        <option value="0">All </option>
                                        <option value="201">
                                        <?php echo trim(strtolower($mosConfig_owner))!="epb"?"Info Product Sale":"Trade Lead Sale"; ?> </option>
                                        <?php if(strtolower($mosConfig_owner)!="epb"){ ?>
                                        <option value="202">Directory Sale</option>
                                        <?php } ?>
                                        <option value="-999">Office Use</option>
                                        <option value="-99">Summary</option>
                                        </select>
                               ...
                               <tr width=100%>
                                ...
                                <tr>
                                        ...
                                        <td  width=18% align=right>
                                        <?php
                                            info_Product_Sales_Report_html::PdfIcon(  );
                                        ?>
                                        </td>
                                        </tr>
                                        </table>
                ...
                <input type="hidden" name="option" value="com_info_product_sales_report" />
