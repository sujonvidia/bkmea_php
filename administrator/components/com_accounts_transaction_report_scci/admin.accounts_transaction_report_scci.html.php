<?php
/**
* @version $Id: admin.accounts_transaction_report_scci.html.php,v 1.5 2006/04/02 06:49:32 morshed Exp $
* @package Mambo
        ...
        */
        function View( &$lists,$option) {
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_accounts_transaction_report_scci&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id;
                ...
                <input type="hidden" name="option" value="com_accounts_transaction_report_scci" />
