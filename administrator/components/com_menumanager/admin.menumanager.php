<?php
/**
* @version $Id: admin.menumanager.php,v 1.11 2005/01/07 16:25:40 stingrey Exp $
* @package Mambo
* @subpackage Menus
...
function saveMenu() {
	...
	if ( $old_menutype == 'mainmenu' ) {
		if ( $menutype <> 'mainmenu' ) {
			echo "<script> alert('You cannot rename the \'mainmenu\' Menu as this will disrupt the proper operation of Camellia'); window.history.go(-1); </script>\n";
			exit;			
		}
	}
