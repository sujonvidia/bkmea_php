<?php
/**
* @version $Id: admin.membership_edit_scci.html.php,v 1.24 2006/07/31 07:37:30 morshed Exp $
* @package Mambo
* @subpackage Weblinks
        ...
        function editMembershipA( &$lists, $option, $id, $start_date, $end_date ,&$rows_importer,&$rows_exporter,&$rows_manufacturer,&$rows_trader,&$rows_dealer,&$rows_indentor,&$rows_assembler,&$rows_service_provider ) {
                ...
                function copy_propietor_information(){
                 ...
                 function newwindow(from)
                 {
                    ...
                    closeNewWindow();
                    page='../popup/proposer_info.php?from='+from+'&formid=0';
                ...
                function submitbutton(pressbutton) {
                        ...
                        else if(document.adminForm.tabselection.value=="0")
                        {
                                ...
                                }else if(form.member_reg_no.value == "" || form.member_reg_no.value == 0 ){
                                ...
                                if(form.firm_reg_address_street.value == ""){
                                   ...
                                   if(form.applicant_name.value == ""){
                                       alert("Name of the proprietor cannot be blank");
                                       form.applicant_name.focus();
                                        ...
                                        alert("Name of the representative cannot be blank");
                                ...
                                start =trim(form.trade_licence_issue_date.value);
                                  ...
                                  if(trim(form.trade_licence_no.value) == ""){
                                           ...
                                           alert("Trade license authority cannot be blank");
                        ...
                        }else if (document.adminForm.tabselection.value=="5"){


                                    if(trim(form.proposer1_name.value) == ""){
                                           alert("Enter the name of proposer");
                                           form.proposer1_name.focus();
                                    }else if(trim(form.proposer1_firm_name.value) == ""){
                                           alert("Enter the firm's name of Proposer");
                                           form.proposer1_firm_name.focus();
                                    }else if(trim(form.proposer1_member_reg_no.value) == "" || trim(form.proposer1_member_reg_no.value) == 0 ){
                                           alert("Enter membership code of proposer");
                                           form.proposer1_member_reg_no.focus();
                                    }else if (trim(form.proposer2_name.value) == ""){
                                           alert("Enter the name of seconder");
                                           form.proposer2_name.focus();
                                    }else if(trim(form.proposer2_firm_name.value) == ""){
                                           alert("Enter the firm's name of seconder");
                                           form.proposer2_firm_name.focus();
                                    }else if(trim(form.proposer2_member_reg_no.value) == ""  || trim(form.proposer2_member_reg_no.value) == 0  ){
                                           alert("Enter the membership code of seconder");
                               ...
                               <tr width=100%>
                                ...
                                <tr width=100%>
                                        ...
                                        * Membership Code :
                                        ...
                                        <td >
                                        <input class="text_area" type="text" name="member_reg_no" value="<?php echo $_SESSION['member_reg_no']; ?>" size="30" maxlength="10"  onKeyUp="javascript:check_IntNumber('member_reg_no',3);" />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td  align="right">
                                ...
                                <tr width=100%>
                                        ...
                                        <td >
                                        <input readonly class="text_area" type="text" name="date_of_formation" id="date_of_formation" value="<?php echo mosHTML::ConvertDateDisplayShort($_SESSION['date_of_formation']); ?>" size="20"   />
...
?>                             <table class="adminform">
                                        ...
                                        <td >
                                        <input class="text_area" type="text" name="firm_mobile" value="<?php echo $_SESSION['firm_mobile']; ?>" size="54" maxlength="50"  />
                                        </td>
                                </tr>
                                            <tr width=100%>
                                                    <td  align="right">
                                 ...
                                 <tr width=100%>
                                        ...
                                        <td >
                                        <input class="text_area" type="text" name="head_office_mobile" value="<?php echo $_SESSION['head_office_mobile']; ?>" size="54" maxlength="50"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td  align="right">
...
?>
                            ...
                            <tr width=100%>
                                        ...
                                        * Name of the Proprietor :
                                        ...
                                        &nbsp;&nbsp;First Name :
                                        <input class="text_area" type="text" name="applicant_name" value="<?php echo $_SESSION['applicant_name']; ?>" size="20" maxlength="25"  />
                                        &nbsp;&nbsp;Last Name
                                        <input class="text_area" type="text" name="applicant_last_name" value="<?php echo $_SESSION['applicant_last_name']; ?>" size="20" maxlength="25"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td  align="right">
                                ...
                                <?php
                                global $mosConfig_live_site;
                                $image_link="$mosConfig_live_site/administrator/images/photograph/$id/".strtolower($_SESSION['applicant_photograph']);
                                ...
                                <tr width=100%>
                                        ...
                                        * Name of the Representative :
                                        ...
                                        &nbsp;&nbsp;First Name
                                        <input class="text_area" type="text" name="representative_name" value="<?php echo $_SESSION['representative_name']; ?>" size="20" maxlength="25"  />
                                        &nbsp;&nbsp;Last Name
                                        <input class="text_area" type="text" name="representative_last_name" value="<?php echo $_SESSION['representative_last_name']; ?>" size="20" maxlength="25"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td  align="right">
                                ...
                                <?php
                                global $mosConfig_live_site;
                                $image_link="$mosConfig_live_site/administrator/images/photograph/$id/".strtolower($_SESSION['representative_photograph']);
...
?>
                            ...
                            <tr width=100%>
                                ...
                                <tr width=100%>
                                        ...
                                        &nbsp;&nbsp;* First Name:
                                        <input class="text_area" type="text" name="proposer1_name" value="<?php echo $_SESSION['proposer1_name']; ?>" size="25" maxlength="25"  />
                                        &nbsp;&nbsp;&nbsp;Last Name :
                                        <input class="text_area" type="text" name="proposer1_last_name" value="<?php echo $_SESSION['proposer1_last_name']; ?>" size="25" maxlength="25"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td width=30% align="right">
                                        * Name of the Firm :
                                        ...
                                        <td width=70%>
                                        <input class="text_area" type="text" name="proposer1_firm_name" value="<?php echo $_SESSION['proposer1_firm_name']; ?>" size="50" maxlength="150"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td width=30% align="right">
                                        ...
                                        <td width=70%>
                                        <input class="text_area" type="text" name="proposer1_address" value="<?php echo $_SESSION['proposer1_address']; ?>" size="50" maxlength="255"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td width=30% align="right">
                                        * Membership No. :
                                        ...
                                        <td width=70%>
                                        <input class="text_area" type="text" name="proposer1_member_reg_no" value="<?php echo $_SESSION['proposer1_member_reg_no']; ?>" size="50" maxlength="20" onKeyUp="javascript:check_IntNumber('proposer1_member_reg_no',3);"  />
                                        </td>
                                </tr>
                                <tr>
                                      <td>
                                ...
                                <tr width=100%>
                                        ...
                                        &nbsp;&nbsp;* First Name :
                                        <input class="text_area" type="text" name="proposer2_name" value="<?php echo $_SESSION['proposer2_name']; ?>" size="25" maxlength="25"  />
                                        &nbsp;&nbsp;Last Name :
                                        <input class="text_area" type="text" name="proposer2_last_name" value="<?php echo $_SESSION['proposer2_last_name']; ?>" size="25" maxlength="25"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td width=30% align="right">
                                        * Name of the Firm :
                                        ...
                                        <td width=70%>
                                        <input class="text_area" type="text" name="proposer2_firm_name" value="<?php echo $_SESSION['proposer2_firm_name']; ?>" size="50" maxlength="150"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td width=30% align="right">
                                        ...
                                        <td width=70%>
                                        <input class="text_area" type="text" name="proposer2_address" value="<?php echo $_SESSION['proposer2_address']; ?>" size="50" maxlength="255"  />
                                        </td>
                                </tr>
                                <tr width=100%>
                                        <td width=30% align="right">
                                        * Membership No. :
                                        ...
                                        <td width=70%>
                                        <input class="text_area" type="text" name="proposer2_member_reg_no" value="<?php echo $_SESSION['proposer2_member_reg_no']; ?>" size="50" maxlength="20" onKeyUp="javascript:check_IntNumber('proposer2_member_reg_no',3);" />
...
?>
                            <table class="adminform">
                                ...
                                <!--tr width=100%>
                                        ...
                                        <td >
                                        <input class="text_area" type="checkbox" name="importer" <?php echo $_SESSION['importer_selected'];?> />&nbsp;Importer
                                        <input class="text_area" type="hidden" name="importer_data" value="1" />
                                        &nbsp;&nbsp;
                                        <input class="text_area" type="checkbox" name="exporter" <?php echo $_SESSION['exporter_selected'];?> />&nbsp;Exporter
                                        <input class="text_area" type="hidden" name="exporter_data" value="2" />
                                        &nbsp;&nbsp;
                                        <input class="text_area" type="checkbox" name="indentor" <?php echo $_SESSION['indentor_selected'];?> />&nbsp;Indentor
                                        <input class="text_area" type="hidden" name="indentor_data" value="3" />
                                        </td>
                                </tr-->
...
$tabs->endTab();
                ...
                <!--input type="hidden" name="option" value="<?php echo $option;?>" /-->
                <input type="hidden" name="option" value="com_membership_edit_scci" />
                ...
                <?php
                     $sl=1;
                      foreach ($rows as $row){
                         ...
                         echo $sl.". ".$row->hscode.", ".$row->name."&nbsp;&nbsp;".$countryList."&nbsp;&nbsp;<a href=\"javascript:popupHSCode('edit',$member_id,$row->id,$hscodeType,$businessType,$countryId);\" style=\"text-decoration:none;\"><b>Edit</b></a>"."/&nbsp;<a href=\"index2.php?option=com_membership_edit_scci&task=dbli&member_id=$member_id&product_id=$row->id&businessType=$businessType&member_product_id=$row->member_product_id\" style=\"text-decoration:none;\"><b>Delete</b></a>"."<br>";
                         $sl++;
                      }
        }
