<?php
/**
* @version $Id: admin.member_type_scci.html.php,v 1.2 2006/02/19 10:07:09 morshed Exp $
* @package Mambo
...
class Member_Type_html {
        ...
        */
        function show( &$rows, &$pageNav) {
                ...
                for ($i=0, $n=count( $rows ); $i < $n; $i++) {
                        ...
                        $link = 'index2.php?option=com_member_type_scci&task=editA&hidemainmenu=1&id='. $row->id;
                ...
                <input type="hidden" name="option" value="com_member_type_scci" />
        ...
        */
        function moveMember_TypeSelect( $option, $cid, $SectionList, $items, $sectionOld, $contents, $redirect ) {
                ?>
                <form action="index2.php" method="post" name="adminForm">
                <br />
                <table class="adminheading">
        ...
        */
        function copyMember_TypeSelect( $option, $cid, $SectionList, $items, $sectionOld, $contents, $redirect ) {
                ?>
                <form action="index2.php" method="post" name="adminForm">
                <br />
                <table class="adminheading">
