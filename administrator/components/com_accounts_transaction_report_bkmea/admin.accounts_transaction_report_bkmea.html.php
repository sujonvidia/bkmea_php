<?php
/**
* @version $Id: admin.accounts_transaction_report_bkmea.html.php,v 1.4 2006/04/30 10:13:44 nnabi Exp $
* @package Mambo
        ...
        */
        function View( &$lists,$option) {
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_accounts_transaction_report_bkmea&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;category_id='+member_category;
