<?php
/**
* @version $Id: admin.member_report_ccci.html.php,v 1.16 2006/08/27 04:43:20 morshed Exp $
* @package Mambo
        ...
        */
        function View( &$lists) {
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_member_report_ccci&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;is_outside='+is_outside+'&amp;location='+location+'&amp;membership_no='+membership_no;
                ...
                <input type="hidden" name="option" value="com_member_report_ccci" />
