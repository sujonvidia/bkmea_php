<?php
/**
* @version $Id: admin.config_bkmea.html.php,v 1.24 2006/12/28 08:52:16 morshed Exp $
* @package Mambo
* @subpackage Config
...
?>
                <table class="adminform">
                        ...
                        <tr>
                                ...
                                <td  width="65%" align="left">Tk.&nbsp;<input  class="text_area" type="text" name="config_local_general_contact_member" value="<?php echo $row->config_local_general_contact_member; ?>" onKeyUp="javascript:check_FloatNumber('config_local_general_contact_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                                <td>General contact of foreign organization </td>
                                <td>Tk.&nbsp;<input type="text"  class="text_area" name="config_foreign_general_contact_member"  value="<?php echo $row->config_foreign_general_contact_member; ?>"  onKeyUp="javascript:check_FloatNumber('config_foreign_general_contact_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                                <td>Full profile of local organization </td>
                                <td>Tk.&nbsp;<input type="text"  class="text_area" name="config_local_detail_contact_member"  value="<?php echo $row->config_local_detail_contact_member; ?>"  onKeyUp="javascript:check_FloatNumber('config_local_detail_contact_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                                <td>Full profile of foreign organization </td>
                                <td>Tk.&nbsp;<input type="text"  class="text_area" name="config_foreign_detail_contact_member"  value="<?php echo $row->config_foreign_detail_contact_member; ?>"  onKeyUp="javascript:check_FloatNumber('config_foreign_detail_contact_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                                <td width="35%">General contact of local organization </td>
                                <td  width="65%" align="left">Tk.&nbsp;<input  class="text_area" type="text" name="config_local_general_contact_non_member" value="<?php echo $row->config_local_general_contact_non_member; ?>" onKeyUp="javascript:check_FloatNumber('config_local_general_contact_non_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                               <td>General contact of foreign organization </td>
                                <td>Tk.&nbsp;<input type="text"  class="text_area" name="config_foreign_general_contact_non_member"  value="<?php echo $row->config_foreign_general_contact_non_member; ?>"  onKeyUp="javascript:check_FloatNumber('config_foreign_general_contact_non_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                                <td>Full profile of local organization </td>
                                <td>Tk.&nbsp;<input type="text"  class="text_area" name="config_local_detail_contact_non_member"  value="<?php echo $row->config_local_detail_contact_non_member; ?>"  onKeyUp="javascript:check_FloatNumber('config_local_detail_contact_non_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                        <tr>
                                <td>Full profile of foreign organization </td>
                                <td>Tk.&nbsp;<input type="text"  class="text_area" name="config_foreign_detail_contact_non_member"  value="<?php echo $row->config_foreign_detail_contact_non_member; ?>"  onKeyUp="javascript:check_FloatNumber('config_foreign_detail_contact_non_member','Enter valid amount');" size="15" maxlength="10"></td>
                        </tr>
                </table>
<?php
        $tabs->endTab();  
