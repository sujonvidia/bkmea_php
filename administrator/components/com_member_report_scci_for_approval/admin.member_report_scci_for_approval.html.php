<?php
/**
* @version $Id: admin.member_report_scci_for_approval.html.php,v 1.1 2006/07/16 11:31:48 morshed Exp $
* @package Mambo
...
* @subpackage Categories
*/
class Member_Report_for_approval_html {
        ...
        */
        function View( &$lists) {
                ...
                global $for,$mailmerge, $office_copy;
                      $title="Member List for Approval";
                ...
                function createPdfLink(){
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_member_report_scci_for_approval&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;office_copy='+office_copy+'&amp;membership_no='+membership_no;
                        ...
                        <td valign="top" width="60%">
                               ...
                               <tr width=100%>
                                ...
                                <tr>
                                        ...
                                        <td  width=18% align=right>
                                        <?php
                                            Member_Report_for_approval_html::PdfIcon(  );
                                        ?>
                                        </td>
                                        </tr>
                                        </table>
                ...
                <input type="hidden" name="option" value="com_member_report_scci_for_approval" />
