<?php
/**
* @version $Id: admin.non_member_ccci.php,v 1.4 2006/03/04 05:37:34 nnabi Exp $
* @package Mambo
* @subpackage Weblinks
...
function saveMembership( $option, $id ) {
            ...
            if ($id!=0)
            {
                ...
                if($_POST['money_receipt_no']!=""){
                    ...
                    if(count($total_row)>0 ) {
                      ...
                      .",money_receipt_no,date,user_id,reg_date)"
                      ." values ('".$insert_id
   ...
   if($id==0)
       mosRedirect( "index2.php?option=com_non_member_ccci&mosmsg=".$msg );
   else
       mosRedirect( "index2.php?option=com_non_member_ccci&task=editA&id=".$id."&mosmsg=".$msg );
...
function cancelMembership( $option ) {
       ...
       // $row->checkin();
        MemberSessionUnregister();
        mosRedirect("index2.php?option=com_non_member_ccci" );
}
