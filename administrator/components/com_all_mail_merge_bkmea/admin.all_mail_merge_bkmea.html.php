<?php
/**
* @version $Id: admin.all_mail_merge_bkmea.html.php,v 1.1 2007/04/08 04:36:44 aslam Exp $
* @package Mambo
	...
	function View( &$lists) {
		...
		global $for;
                ...
                function createPdfLink(){
                	var order_by,form, link, status, type_id, report_for, date_from='', date_to='',membership_no;
                	...
                	link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_all_mail_merge_bkmea&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;category_id='+member_category+'&amp;membership_no='+membership_no+'&amp;order_by='+order_by;
                ...
                <input type="hidden" name="option" value="com_all_mail_merge_bkmea" />
