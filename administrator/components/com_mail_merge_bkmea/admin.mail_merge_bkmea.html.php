<?php
/**
* @version $Id: admin.mail_merge_bkmea.html.php,v 1.5 2006/02/19 10:13:26 morshed Exp $
* @package Mambo
        ...
        */
        function View( &$lists) {
                ...
                function createPdfLink(){
                      var order_by,form, link, status, type_id, report_for, date_from='', date_to='';
                      ...
                      link = '<?php echo $mosConfig_live_site; ?>'+'/index2.php?option=com_mail_merge_bkmea&amp;do_pdf=1&amp;type_id='+type_id+'&amp;report_for='+report_for+'&amp;date_from='+date_from+'&amp;date_to='+date_to+'&amp;last_reg_year_id='+last_reg_year_id+'&amp;category_id='+member_category+'&amp;order_by='+order_by;
