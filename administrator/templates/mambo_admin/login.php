<?php
/**
* @version $Id: login.php,v 1.4 2005/01/06 01:13:26 eddieajau Exp $
* @package Mambo
...
<div id="wrapper">
    <div id="header">
           <div id="mambo"><img src="templates/mambo_admin/images/camellia.gif" alt="Camelia Logo" /></div>
    </div>
</div>
<div id="ctr" align="center">
        <div class="login">
                <div class="login-form">
                        <?php $forced=mosGetParam($_REQUEST,'forced','');
                                if ($forced=="yes")
                                        echo _FORCED_LOGOUT."<br />";
                        ?>
                ...
                <div class="login-text">
                        <div class="ctr"><img src="templates/mambo_admin/images/security.png" width="120" height="64" alt="security" border="0" /></div>
                <p>Welcome to IMS!</p>
