<?php
/**
* @version $Id: ccci_mod_fullmenu.php,v 1.28 2006/12/26 07:12:29 morshed Exp $
* @package Mambo
...
?>                                ['<img src="../includes/js/ThemeOffice/config.png" />','Global Configuration','index2.php?option=com_config_ccci',null,'Configuration'],
<?php
                        //}
                        if ($manageLanguages) {
        ...
        <?php
                ...
                ?>
                        ...
                        // ['<img src="../includes/js/ThemeOffice/language.png" />','Member Type','index2.php?option=com_member_type',null,'Member Type'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Registration Year','index2.php?option=com_member_reg_year_ccci',null,'Registration Year'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Charge Setup','index2.php?option=com_membership_charge_ccci',null,'Charge Setup'],
         <?php
                 }
         ?>
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Member Profile','index2.php?option=com_membership_ccci',null,'Member Profile'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Group/ Town Association','index2.php?option=com_member_group_town_ccci',null,'Group/ Town Association'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Non Member Profile','index2.php?option=com_non_member_ccci',null,'Non Member Profile'],
                           ['<img src="../includes/js/ThemeOffice/content.png" />','Expire Member','index2.php?option=com_expire_member_list',null,'Expire Member'],
                           ['<img src="../includes/js/ThemeOffice/content.png" />','Member Renew','index2.php?option=com_membership_renew_ccci',null,'Member Renew'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Member Certificate','index2.php?option=com_membership_certificate_ccci',null,'Member Certificate'],

                         ['<img src="../includes/js/ThemeOffice/content.png" />','Delegate Voter','index2.php?option=com_delegate_voter_ccci',null,'Delegate Voter'],
...
//                            ['<img src="../includes/js/ThemeOffice/language.png" />','Configuration','index2.php?option=com_docman&section=config',null,'Configuration'],
         ...
         _cmSplit,
            [null,'Report',null,null,'Report',
                            ['<img src="../includes/js/ThemeOffice/document.png" />','Member List','index2.php?option=com_member_report_ccci&for=0',null,'Member List']
                            ,['<img src="../includes/js/ThemeOffice/document.png" />','Outstanding Subscription','index2.php?option=com_member_report_ccci&for=1',null,'Outstanding Subscription']
                            ,['<img src="../includes/js/ThemeOffice/document.png" />','Mailing List','index2.php?option=com_mail_merge_ccci&for=0',null,'Mailing List']
                        <?php
                         if ($usertype=='Super Administrator')
                         {
                         ?>
                                 ,['<img src="../includes/js/ThemeOffice/document.png" />','Account Transaction','index2.php?option=com_accounts_transaction_report_ccci',null,'Account Transaction']
                                ,['<img src="../includes/js/ThemeOffice/document.png" />','Voter List','index2.php?option=com_member_voterlist_ccci',null,'Voter List']
                        <?php
                        }
                        if($usertype=='Super Administrator'){ ?>
                           ,['<img src="../includes/js/ThemeOffice/sections.png" />','History',null,null,'History',
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Member','index2.php?option=com_member_history_report&for=ccci',null,'Member'],
                             ['<img src="../includes/js/ThemeOffice/document.png" />','User','index2.php?option=com_user_report&for=ccci',null,'User'],
                             ]
                            ,['<img src="../includes/js/ThemeOffice/sections.png" />','Info Product',null,null,'Info Product',
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Info Product Sales','index2.php?option=com_info_product_sales_report&for=ccci',null,'Info Product Sales Report'],
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Info Product List','index2.php?option=com_info_product_list_report&for=ccci',null,'Info Product List'],
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Customer','index2.php?option=com_info_product_customer_report&for=ccci',null,'Customer']
                           ]
                        <?php
                        }
                        if ($usertype=='Super Administrator'||$usertype=='Administrator')
