<?php
/**
* @version $Id: scci_mod_fullmenu.php,v 1.34 2006/12/26 07:11:05 morshed Exp $
* @package Mambo
...
?>                                ['<img src="../includes/js/ThemeOffice/config.png" />','Global Configuration','index2.php?option=com_config_scci',null,'Configuration'],
<?php
                        //}
                        if ($manageLanguages) {
        ...
        <?php
                ...
                ?>
                        ...
                        // ['<img src="../includes/js/ThemeOffice/language.png" />','Member Type','index2.php?option=com_member_type',null,'Member Type'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Registration Year','index2.php?option=com_member_reg_year_scci',null,'Registration Year'],
                         ['<img src="../includes/js/ThemeOffice/content.png" />','Charge Setup','index2.php?option=com_membership_charge_scci',null,'Charge Setup'],


         <?php
                 }
         ?>
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Ordinary/ Associate','index2.php?option=com_membership_scci',null,'Ordinary/ Associate Membership'],
                          ...
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Group/ Town Association','index2.php?option=com_member_group_town_scci',null,'Group/ Town Association Membership'],
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Membership Expiry','index2.php?option=com_expire_member_list',null,'Membership Expiry'],
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Membership Renewal','index2.php?option=com_membership_renew_scci',null,'Membership Renewal'],
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Membership Certificate','index2.php?option=com_membership_certificate_scci',null,'Membership Certificate'],
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Member ID Card','index2.php?option=com_membership_idcard_scci',null,'Member ID Card'],
           <?php
                if ($usertype=='Super Administrator' )
                {
                ?>
                          ['<img src="../includes/js/ThemeOffice/content.png" />','Assign Voter','index2.php?option=com_voter_scci',null,'Assign Voter']
           <?php
                 }
         ?>
           ],
...
//                            ['<img src="../includes/js/ThemeOffice/language.png" />','Configuration','index2.php?option=com_docman&section=config',null,'Configuration'],
         ...
         _cmSplit,
            [null,'Report',null,null,'Report',
                            ['<img src="../includes/js/ThemeOffice/document.png" />','Member List','index2.php?option=com_member_report_scci&for=0&mailmerge=0&office_copy=1',null,'Member List']
                            ,['<img src="../includes/js/ThemeOffice/document.png" />','Member List for Approval','index2.php?option=com_member_report_scci_for_approval&office_copy=1',null,'Member List for Approval']
                            ,['<img src="../includes/js/ThemeOffice/document.png" />','Outstanding Subscription','index2.php?option=com_member_report_scci&for=1&mailmerge=0&office_copy=0',null,'Outstanding Subscription']
                            ,['<img src="../includes/js/ThemeOffice/document.png" />','Mailing List','index2.php?option=com_member_report_scci&for=0&mailmerge=1&office_copy=0',null,'Mailing List']
                        <?php
                         if ($usertype=='Super Administrator')
                         {
                         ?>

                                ,['<img src="../includes/js/ThemeOffice/document.png" />','Voter List','index2.php?option=com_member_voterlist_scci&for=0',null,'Voter List']
                                ,['<img src="../includes/js/ThemeOffice/document.png" />','Voter ID Card','index2.php?option=com_member_voterlist_scci&for=1',null,'Voter ID Card']
                                ,['<img src="../includes/js/ThemeOffice/document.png" />','Accounts Report','index2.php?option=com_accounts_transaction_report_scci',null,'Accounts Report']
                        <?php
                        }
                        if($usertype=='Super Administrator'){ ?>
                           ,['<img src="../includes/js/ThemeOffice/sections.png" />','History',null,null,'History',
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Member','index2.php?option=com_member_history_report&for=scci',null,'Member'],
                             ['<img src="../includes/js/ThemeOffice/document.png" />','User','index2.php?option=com_user_report&for=scci',null,'User'],
                             ]
                            ,['<img src="../includes/js/ThemeOffice/sections.png" />','Info Product',null,null,'Info Product',
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Info Product Sales','index2.php?option=com_info_product_sales_report&for=scci',null,'Info Product Sales Report'],
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Info Product List','index2.php?option=com_info_product_list_report&for=scci',null,'Info Product List'],
                             ['<img src="../includes/js/ThemeOffice/document.png" />','Customer','index2.php?option=com_info_product_customer_report&for=scci',null,'Customer']
