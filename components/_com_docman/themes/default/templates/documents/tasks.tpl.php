...
* @version $Id: tasks.tpl.php,v 1.2 2006/03/23 07:37:06 nnabi Exp $
...
if ( $this->theme->conf->task_details ) :
        if( $this->doc->links->details ) :
                ?><a id="dm_taskbar" href="<?php echo $this->doc->links->details?>&cat_id=<?php echo $this->doc->data->catid?>"><span><?php echo _DML_TPL_DOC_DETAILS ?></span></a><?php
    endif;
endif;
