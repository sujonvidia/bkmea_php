...
* @version $Id: menu.tpl.php,v 1.2 2006/05/24 06:28:31 nnabi Exp $
...
<div id="dm_header_link" align="right">    <br>
<?php
if($this->theme->conf->menu_home) :
        ...
        <!--div>
                ...
                <a href="<?php echo $this->links->home."&upload_year=1";?>"><?php echo "Upload Year";?></a>&nbsp;|&nbsp;
        </div-->
        <?php
endif;
