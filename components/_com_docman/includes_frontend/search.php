...
* @version $Id: search.php,v 1.3 2006/05/09 07:11:46 morshed Exp $
...
function fetchSearchForm($gid, $itemid)
{
    ...
    $lists['search_type']  = mosAdminMenus::InfoProductSearchOption( 'search_type', $_POST['search_type'] );
...
function getSearchResult($gid, $itemid)
{
    ...
    $searchList = array(
        array('search_mode' => $search_mode ,
            'search_phrase' => $search_phrase,'search_in'=>$search_type));
