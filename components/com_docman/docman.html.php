...
* @version $Id: docman.html.php,v 1.69 2007/03/01 08:33:01 aslam Exp $
...
class HTML_docman
{
    ...
    function purchase_step2_member($pid,&$lists,$directorytype,$member_price,$nonmember_price)
    {
        ...
        <script language="javascript" type="text/javascript">
               ...
               else if(mosConfig_owner!="bkmea" && form.type_id.value == 0){
        ...
        <table width="100%" cellspacing="0" >
           ...
           <tr width=100%>
               ...
               if (strtolower(trim($mosConfig_owner))=="ccci")
               ...
               <td  width="75%">
               <input type="text" name="member_reg_no" size="25" maxlength="11" onKeyUp="javascript:check_IntNumber('member_reg_no','Enter valid membership number.');" />
        ...
        <td></td>
       <td>
          <input type="button" name="Validity" class="button" value="Search Member" onclick=javascript:newwindow(); />
       </td>
    </tr-->
    ...
    function purchase_step4($pid,$customer,$directorytype,$member_price,$nonmember_price)
    {
        ...
        <table width="100%" cellspacing="0" >
           <tr>
             <td colspan=2>
             <b>Information Product(s) Coupon</b>
             </td>
           </tr>
           <tr width=100%>
               <td   width="30%">
    ...
    function purchase_step5(&$rows,$pid,$directorytype,$member_price,$nonmember_price,$invoice_id,$et)
    {
        ...
        <table width="100%" cellspacing="0" >
           ...
           if( count($rows)>0 ){
               ...
               $link = "<A href=\"javascript:update_dmcounter($docid,'$dmfilename',$catid,'',$invoice_id,$et);\" title=\"Info Product\" onMouseOver=\"javascript:window.status='Info Product';return true\"><b>Open Info Product</b></a>";
               ...
               $pid=$pid?$pid:0;
               $link = "<A href=\"javascript:update_dmcounter($pid,'$directorytype',0,'$search_criteria',$invoice_id,$et);\" title=\"Info Product\" onMouseOver=\"javascript:window.status='Info Product';return true\"><b>Open Info Product</b></a>";
           }
    ...
    function sales_tracker()
    {
        ...
        <script language="javascript" type="text/javascript">
               ...
               var newWin;
                function newwindow(){
                      if (null != newWin && !newWin.closed)
                         closeNewWindow();
                      page='./popup/infoProductCoupon.php?formName=userForm';
        ...
        <table width="100%" cellspacing="0" >
           <tr>
             <td colspan=2>
             <b>Info Product Coupon Information</b>
             </td>
           </tr>
           <tr height="5">
             <td colspan=2>
