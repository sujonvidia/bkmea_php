...
* @version $Id: tooltip.tpl.php,v 1.1 2006/03/19 06:48:56 morshed Exp $
...
if($this->theme->conf->details_description) :
        ?>
         <tr>
                 <td>
                 <!--<?php echo _DML_TPL_DESC ?>-->
                 Abstract with Description</td><td><?php echo $this->doc->data->dmdescription ?></td>
         </tr>
        <?php
endif;
...
if($this->theme->conf->details_filetype) :
        ?>
         <tr>
                 <td><?php echo _DML_TPL_FTYPE ?></td><td><?php echo strtoupper($this->doc->data->filetype); ?>
                 <!--&nbsp;&nbsp(<?php echo _DML_TPL_MIME.$this->doc->data->mime ?>)--></td>
        </tr>
        <?php
endif;
...
if($this->theme->conf->details_downloads) :
        ?>
         <tr>
                 <td><?php echo "#Download"; ?></td><td><?php echo $this->doc->data->dmcounter; ?></td>
         </tr>
        <?php
endif;
?>
