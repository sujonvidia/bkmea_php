<?php
/**
* @version $Id: directory_ccci.html.php,v 1.7 2006/06/21 08:02:06 morshed Exp $
* @package Mambo
* @subpackage Search
        ...
        function searchbox( $searchword, &$lists, $params,$pid ) {
                ...
                <table class="contentpaneopen<?php echo $params->get( 'pageclass_sfx' ); ?>">
                        ...
                        <tr>
                                ...
                                &nbsp;&nbsp;Is Outside City <?php echo $lists['is_outside']; ?>
                                </td>
                        </tr>
                        <tr>
                                <td nowrap="nowrap">
                ...
                <input type="hidden" name="option" value="com_directory_ccci" />
