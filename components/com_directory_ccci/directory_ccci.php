<?php
/**
* @version $Id: directory_ccci.php,v 1.6 2006/05/28 04:13:56 nnabi Exp $
* @package Mambo
* @subpackage Search
...
function viewSearch() {
        ...
        $lists['is_outside']   = mosHTML::yesnoRadioList( 'is_outside', 'class="inputbox"', $_POST['is_outside']!=""?intval($_POST['is_outside']):'');
        ...
        if(isset($_POST['submit1']))
        {
                ...
                $is_outside_city=$_POST['is_outside']!=""?intval($_POST['is_outside']):'all';
                $country_id=$_POST['country_id']!="0"?$_POST['country_id']:'all';
                $business_type=$_POST['business_type']!="0"?$_POST['business_type']:'all';
                $search_criteria=$phrase."__".$text."__".$search_type."__".$product."__".$location."__".$corporate_status."__".$is_outside_city."__".$country_id."__".$business_type;
                ...
                $results=$search_obj->botSearchMemberCcci( "statistics", $phrase, $text, $search_type, $product, $location, $corporate_status, $is_outside_city, $country_id, $business_type);
